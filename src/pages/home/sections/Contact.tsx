...
export function Contact() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1700px] px-5 sm:px-8 lg:px-10 xl:px-14">
        {/* ── Contact Layout ── */}
        <Reveal delay={300}>
          <div className="mx-auto mt-6 max-w-6xl grid gap-10 lg:grid-cols-[1fr_1.2fr] lg:gap-16">
            {/* Left: Info Cards */}
            <div className="flex flex-col justify-top gap-8">
              <div>
                ...
                <h2 className="display-title-extended text-[clamp(3rem,6vw,4.5rem)] leading-[0.95]">
                  ...
                  <span className=" text-foreground">
                    With <span className=" text-gold-gradient">TNPPL</span>
                  </span>
                </h2>
                <p
                ...
                >
                  For partnership enquiries, media requests, or general
                  information.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="stat-card flex flex-col justify-center rounded-2xl px-6 py-6">
                  <p className="text-[11px] font-bold uppercase tracking-[0.26em] text-gold/80 mb-3">
                    Direct Email
                  </p>
                  <a
            ...
            <div className="stat-card rounded-2xl p-6 sm:p-8">
              ...
              <form className="space-y-4" onSubmit={onSubmit}>
                ...
                {result && (
                  <p
                    className={`mt-3 text-center text-[13px] font-medium ${result.includes("success") ? "text-green-400" : "text-gold"}`}
                  >
                    {result}
                  </p>
                )}
